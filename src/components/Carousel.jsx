        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            ...
            <div className="carousel-caption d-none d-md-block">
              ...
              <p>
                ...
                reconocible, gracias también a su afilado frontal proyectado
                hacia adelante.
              </p>
          ...
          <div className="carousel-item">
            ...
            <div className="carousel-caption d-none d-md-block">
              ...
              <p>
                El Lamborghini Huracán es un superdeportivo de diseño
                aerodinámico y tecnología avanzada, inspirado en el átomo de
                carbono y el ADN de la marca italiana.
              </p>
          ...
          <div className="carousel-item">
            ...
            <div className="carousel-caption d-none d-md-block">
              ...
              <p>
                ...
                deportivo del legendario Porsche 718 con el vehículo deportivo
                del futuro.
              </p>
          ...
          <div className="carousel-item">
            ...
            <div className="carousel-caption d-none d-md-block">
              <h5>Audi R8</h5>
              <p>
                El Audi R8 es un automóvil deportivo de alto rendimiento y
                diseño aerodinámico, conocido por su motor central y tracción
                integral quattro.
              </p>
